...
const Tag = ({ category }: { category: ChangelogEntryPointCategory }) => {
    ...
    const getTextAndBgColor = useCallback((category: ChangelogEntryPointCategory) => {
    ...
    return (
        <div className={`${getTextAndBgColor(category)} px-1 py-1 rounded-md flex items-center gap-1`}>
